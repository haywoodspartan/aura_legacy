...
namespace Aura.Data
{
	...
	public class StatsAgeUpDb : DatabaseCSV<StatsAgeUpInfo>
	{
		/// <summary>
		/// Returns the age info (bonus stats) for the given race
		/// at the given age, or null.
		/// </summary>
		/// <param name="race">0 = Human, 1 = Elf, 2 = Giant</param>
		/// <param name="age">10-25</param>
		/// <returns></returns>
		public StatsAgeUpInfo Find(uint race, byte age)
		{
			race = (uint)(race & ~3);
